...
export const TASK_VERIFY_GET_ETHERSCAN_ENDPOINT = 'okverify:get-etherscan-endpoint';
export const TASK_VERIFY_GET_CONTRACT_INFORMATION = 'okverify:get-contract-information';
